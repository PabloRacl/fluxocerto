    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div 
          ...
          style={{
            animation: "fadeInOut 7s ease-in-out infinite, floatCoin 6s ease-in-out infinite",
            animationDelay: "1s",
          }}
        >
        ...
        <div 
          ...
          style={{
            animation: "fadeInOut 6.5s ease-in-out infinite, floatCoin 5s ease-in-out infinite",
            animationDelay: "3.5s",
          }}
        >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-2/3 left-0 w-full h-px bg-gradient-to-r from-transparent via-teal-500/20 to-transparent animate-pulse" style={{ animationDelay: "1s" }} />
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 left-[15%] w-32 h-32 border border-emerald-500/20 rounded-full animate-ping" style={{ animationDuration: "3s" }} />
        <div className="absolute bottom-1/3 right-[18%] w-24 h-24 border border-teal-500/20 rounded-full animate-ping" style={{ animationDuration: "4s", animationDelay: "1s" }} />
      </div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div className="inline-flex items-center justify-center relative">
                ...
                <div className="relative w-28 h-28 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl shadow-2xl flex items-center justify-center animate-bounce" style={{ animationDuration: "2s" }}>
                  <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                {/* Sparkles ao redor */}
                <div className="absolute -top-2 -right-2 text-4xl animate-ping" style={{ animationDuration: "2s" }}>✨</div>
                <div className="absolute -bottom-2 -left-2 text-3xl animate-ping" style={{ animationDuration: "2.5s", animationDelay: "0.5s" }}>💚</div>
              </div>
              ...
              <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed animate-pulse px-4" style={{ animationDuration: "3s" }}>
                Gerencie receitas, despesas, compras e dívidas em um só lugar. 
                <span className="text-emerald-400 font-semibold block mt-2">Simples, inteligente e gratuito.</span>
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 pt-16 px-4">
              {/* Card 1 */}
              <div 
                className="group relative p-8 bg-gradient-to-br from-emerald-950/50 to-slate-900/50 backdrop-blur-md rounded-3xl border border-emerald-500/30 shadow-2xl hover:shadow-emerald-500/40 transition-all duration-300 hover:-translate-y-3 hover:scale-105 overflow-hidden"
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="font-bold text-2xl text-white mb-3 group-hover:text-emerald-300 transition-colors">Controle Total</h3>
                  <p className="text-slate-300 leading-relaxed">Gerencie receitas, despesas, contas e cartões em um só lugar.</p>
                </div>
              </div>

              {/* Card 2 */}
              <div 
                className="group relative p-8 bg-gradient-to-br from-teal-950/50 to-slate-900/50 backdrop-blur-md rounded-3xl border border-teal-500/30 shadow-2xl hover:shadow-teal-500/40 transition-all duration-300 hover:-translate-y-3 hover:scale-105 overflow-hidden"
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="font-bold text-2xl text-white mb-3 group-hover:text-teal-300 transition-colors">Módulo de Compras</h3>
                  <p className="text-slate-300 leading-relaxed">Registre compras com itens detalhados e histórico de preços.</p>
                </div>
              </div>

              {/* Card 3 */}
              <div 
                className="group relative p-8 bg-gradient-to-br from-green-950/50 to-slate-900/50 backdrop-blur-md rounded-3xl border border-green-500/30 shadow-2xl hover:shadow-green-500/40 transition-all duration-300 hover:-translate-y-3 hover:scale-105 overflow-hidden"
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="font-bold text-2xl text-white mb-3 group-hover:text-green-300 transition-colors">Dashboard Inteligente</h3>
                  <p className="text-slate-300 leading-relaxed">Acompanhe gráficos, indicadores e alertas em tempo real.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <footer className="w-full p-6 text-center text-slate-400 text-sm">
          <p className="flex items-center justify-center gap-2 animate-pulse">
            ...
            <span className="w-1 h-1 bg-emerald-400 rounded-full animate-ping" style={{ animationDelay: "0.5s" }} />
