    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="relative z-10 p-8">
        <div className="max-w-2xl mx-auto">
          {/* Título */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Nova Conta</h1>
            <p className="text-slate-400">Cadastre uma nova conta bancária ou cartão</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 bg-slate-900/50 backdrop-blur-md rounded-2xl border border-emerald-500/20 p-8">
            ...
            <div>
              ...
              <input
                ...
                placeholder="0,00"
              />
              <p className="text-xs text-slate-500 mt-1">Deixe em branco para zerado</p>
            </div>
