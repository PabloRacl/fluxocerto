...
export default function NewCategoryModal({ 
  ...
  const filteredParents = parentCategories.filter((cat: any) => cat.type === formData.type);
            ...
            <div className="flex items-center justify-between p-6 border-b border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Cadastre uma nova categoria de receita ou despesa</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              <div className="p-4 bg-slate-800/30 rounded-2xl border border-slate-700">
                ...
                <ul className="space-y-1 text-xs text-slate-400">
                  <li>• Categorias de <strong className="text-emerald-400">Receita</strong> são para entradas de dinheiro</li>
                  <li>• Categorias de <strong className="text-red-400">Despesa</strong> são para saídas de dinheiro</li>
                  <li>• Use subcategorias para organizar melhor (ex: Alimentação → Restaurante)</li>
                </ul>
              </div>
