          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Deixe em branco para criar uma categoria principal, ou selecione
                uma categoria existente do mesmo tipo para criar uma
                subcategoria
              </p>
            </div>
          ...
          <div className="mt-6 p-6 bg-slate-900/30 rounded-2xl border border-slate-800">
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Categorias de <strong>Receita</strong> são para entradas de
                  dinheiro (salário, investimentos, etc.)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400 mt-1">•</span>
                <span>
                  Categorias de <strong>Despesa</strong> são para saídas de
                  dinheiro (alimentação, transporte, etc.)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-400 mt-1">•</span>
                <span>
                  Você pode criar subcategorias para organizar melhor (ex:
