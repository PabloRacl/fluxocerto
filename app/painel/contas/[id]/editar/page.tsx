    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <header className="relative z-10 w-full p-6 flex justify-between items-center backdrop-blur-sm bg-slate-950/50 border-b border-emerald-500/20">
        <div className="flex items-center gap-3">
          <Link href="/painel/contas" className="flex items-center gap-3">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-6 p-6 bg-red-500/10 rounded-2xl border border-red-500/20">
            ...
            <p className="text-slate-400 text-sm mb-4">
              Arquivar esta conta irá ocultá-la da lista principal, mas manterá
            ...
            <button
              onClick={async () => {
                if (
                  confirm(
                    "Tem certeza que deseja arquivar esta conta? Esta ação não pode ser desfeita facilmente.",
                  )
                ) {
                  try {
                    const res = await fetch(`/api/contas/${accountId}`, {
